...
async def generate_thumb(videoid,bot_name):
    try:
        ...
        if 1==1:
            ...
            circle = Image.open("assets/sumit.png")
            ...
            # fonts
            font1 = ImageFont.truetype('assets/font.ttf',  45)
            ...
            image4.text((670, 150), "SUMIT x MUSIC", fill="white", font = font2, stroke_width=3, stroke_fill="white", align ="left") 
